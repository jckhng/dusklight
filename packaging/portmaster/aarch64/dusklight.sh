...
export DUSKLIGHT_PM_GRAPHICS_MODE="${DUSKLIGHT_PM_GRAPHICS_MODE:-dawn-sdl2shim-owned}"
...
log_platform_info() {
  ...
  echo "DUSKLIGHT_PORTMASTER_SDL2SHIM_OWNED_EGL=${DUSKLIGHT_PORTMASTER_SDL2SHIM_OWNED_EGL:-}"
  echo "DUSKLIGHT_PORTMASTER_SDL2SHIM_EXTERNAL_PRESENT=${DUSKLIGHT_PORTMASTER_SDL2SHIM_EXTERNAL_PRESENT:-}"
  echo "DUSKLIGHT_PORTMASTER_SDL_RENDERER_PRESENT=${DUSKLIGHT_PORTMASTER_SDL_RENDERER_PRESENT:-}"
  echo "DUSKLIGHT_PORTMASTER_SDL2SHIM_SWAP_PRESENT=${DUSKLIGHT_PORTMASTER_SDL2SHIM_SWAP_PRESENT:-}"
  echo "DUSKLIGHT_PORTMASTER_SDL2SHIM_DAWN_CONTEXT_PRESENT=${DUSKLIGHT_PORTMASTER_SDL2SHIM_DAWN_CONTEXT_PRESENT:-}"
  echo "DUSKLIGHT_PORTMASTER_SDL_PRESENTER_OWN_CONTEXT=${DUSKLIGHT_PORTMASTER_SDL_PRESENTER_OWN_CONTEXT:-}"
  echo "DUSKLIGHT_PORTMASTER_FBDEV_PRESENT=${DUSKLIGHT_PORTMASTER_FBDEV_PRESENT:-}"
  echo "DUSKLIGHT_PORTMASTER_USE_FBDEV_SIZE=${DUSKLIGHT_PORTMASTER_USE_FBDEV_SIZE:-}"
  echo "DUSKLIGHT_PORTMASTER_PRESENT_INTERVAL=${DUSKLIGHT_PORTMASTER_PRESENT_INTERVAL:-}"
  echo "DUSKLIGHT_PORTMASTER_NO_SURFACE=${DUSKLIGHT_PORTMASTER_NO_SURFACE:-}"
...
resolve_graphics_mode() {
  case "$DUSKLIGHT_PM_GRAPHICS_MODE" in
    auto)
      ...
      ;;
    dawn-sdl|dawn-wayland|dawn-x11|dawn-kmsdrm|dawn-fbdev-sentinel|dawn-sdl2shim|dawn-sdl2shim-real-surface|dawn-sdl2shim-fbdev-present|dawn-sdl2shim-owned|dawn-sdl2shim-native|dawn-sdl2shim-borrow|dawn-sdl2shim-borrow-sdlswap|diag)
...
clear_graphics_flags() {
  ...
  unset DUSKLIGHT_PORTMASTER_SDL2SHIM_OWNED_EGL
  unset DUSKLIGHT_PORTMASTER_SDL2SHIM_EXTERNAL_PRESENT
  unset DUSKLIGHT_PORTMASTER_SDL_RENDERER_PRESENT
  unset DUSKLIGHT_PORTMASTER_SDL2SHIM_SWAP_PRESENT
  unset DUSKLIGHT_PORTMASTER_SDL2SHIM_DAWN_CONTEXT_PRESENT
  unset DUSKLIGHT_PORTMASTER_FBDEV_PRESENT
  unset DUSKLIGHT_PORTMASTER_NO_SURFACE
  unset DUSKLIGHT_PORTMASTER_FORCE_VERTEX_TEXTURE
  unset DUSKLIGHT_PORTMASTER_USE_FBDEV_SIZE
}
...
apply_graphics_mode() {
  ...
  case "$1" in
    ...
    dawn-sdl2shim)
      ...
      export DUSKLIGHT_PORTMASTER_NO_SURFACE=1
      export DUSKLIGHT_PORTMASTER_SDL2SHIM_EXTERNAL_PRESENT=1
      export DUSKLIGHT_PORTMASTER_SDL_RENDERER_PRESENT=1
      ...
      unset DUSKLIGHT_PORTMASTER_SDL2SHIM_OWNED_EGL
      unset DUSKLIGHT_PORTMASTER_SDL2SHIM_SWAP_PRESENT
      unset DUSKLIGHT_PORTMASTER_SDL_PRESENTER_OWN_CONTEXT
      ;;
    dawn-sdl2shim-real-surface)
      export SDL_VIDEODRIVER=sdl2
      export SDL3SHIM_SDL2_LIB="${SDL3SHIM_SDL2_LIB:-libSDL2-2.0.so.0}"
      export DUSKLIGHT_PORTMASTER_SDL2SHIM_EGL_SURFACE=1
      export DUSKLIGHT_PORTMASTER_SDL2SHIM_SWAP_PRESENT=1
      export DUSKLIGHT_PORTMASTER_SDL2SHIM_DAWN_CONTEXT_PRESENT=1
      export DUSKLIGHT_PORTMASTER_FORCE_VERTEX_TEXTURE=1
      unset DUSKLIGHT_PORTMASTER_NO_SURFACE
      unset DUSKLIGHT_PORTMASTER_SDL2SHIM_OWNED_EGL
      unset DUSKLIGHT_PORTMASTER_SDL2SHIM_EXTERNAL_PRESENT
      ...
      unset DUSKLIGHT_PORTMASTER_EGL_FBDEV_SURFACE
      ;;
    dawn-sdl2shim-fbdev-present)
      export SDL_VIDEODRIVER=sdl2
      export SDL3SHIM_SDL2_LIB="${SDL3SHIM_SDL2_LIB:-libSDL2-2.0.so.0}"
      export DUSKLIGHT_PORTMASTER_NO_SURFACE=1
      export DUSKLIGHT_PORTMASTER_FBDEV_PRESENT=1
      export DUSKLIGHT_PORTMASTER_FORCE_VERTEX_TEXTURE=1
      export DUSKLIGHT_PORTMASTER_PRESENT_INTERVAL="${DUSKLIGHT_PORTMASTER_PRESENT_INTERVAL:-2}"
      unset DUSKLIGHT_PORTMASTER_X11_DAWN
      unset DUSKLIGHT_PORTMASTER_EGL_FBDEV_SURFACE
      unset DUSKLIGHT_PORTMASTER_SDL_PRESENTER_OWN_CONTEXT
      unset DUSKLIGHT_PORTMASTER_SDL2SHIM_EGL_SURFACE
    ...
    dawn-sdl2shim-owned)
      ...
      export SDL3SHIM_SDL2_LIB="${SDL3SHIM_SDL2_LIB:-libSDL2-2.0.so.0}"
      export DUSKLIGHT_PORTMASTER_SDL2SHIM_EGL_SURFACE=1
      export DUSKLIGHT_PORTMASTER_SDL2SHIM_OWNED_EGL=1
      export DUSKLIGHT_PORTMASTER_SDL2SHIM_SWAP_PRESENT=1
      export DUSKLIGHT_PORTMASTER_FORCE_VERTEX_TEXTURE=1
      unset DUSKLIGHT_PORTMASTER_NO_SURFACE
      unset DUSKLIGHT_PORTMASTER_SDL2SHIM_EXTERNAL_PRESENT
    ...
    dawn-sdl2shim-borrow)
      ...
      export SDL3SHIM_SDL2_LIB="${SDL3SHIM_SDL2_LIB:-libSDL2-2.0.so.0}"
      export DUSKLIGHT_PORTMASTER_SDL2SHIM_EGL_SURFACE=1
      export DUSKLIGHT_PORTMASTER_SDL2SHIM_SWAP_PRESENT=0
      export DUSKLIGHT_PORTMASTER_FORCE_VERTEX_TEXTURE=1
      unset DUSKLIGHT_PORTMASTER_NO_SURFACE
      unset DUSKLIGHT_PORTMASTER_SDL2SHIM_OWNED_EGL
      unset DUSKLIGHT_PORTMASTER_SDL2SHIM_EXTERNAL_PRESENT
