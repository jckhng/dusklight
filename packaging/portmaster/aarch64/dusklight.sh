...
resolve_graphics_mode() {
  case "$DUSKLIGHT_PM_GRAPHICS_MODE" in
    auto)
      ...
      ;;
    dawn-sdl|dawn-wayland|dawn-x11|dawn-kmsdrm|dawn-fbdev-sentinel|dawn-sdl2shim|dawn-sdl2shim-owned|dawn-sdl2shim-native|dawn-sdl2shim-borrow|dawn-sdl2shim-borrow-sdlswap|diag)
