...
RENDERDOC_DIR="$GAMEDIR/renderdoc"
BIN="$GAMEDIR/dusklight.${DEVICE_ARCH}"

mkdir -p "$RUNTIME_DIR" "$RUNTIME_DIR/home" "$ASSETS_DIR" "$RENDERDOC_DIR/captures"
...
export DUSKLIGHT_PORTMASTER_SKIP_VERTEX_BUFFER_COPY="${DUSKLIGHT_PORTMASTER_SKIP_VERTEX_BUFFER_COPY:-1}"
export DUSKLIGHT_PORTMASTER_ACTOR_STATS="${DUSKLIGHT_PORTMASTER_ACTOR_STATS:-0}"
export DUSKLIGHT_PORTMASTER_PROCESS_DRAW_STATS="${DUSKLIGHT_PORTMASTER_PROCESS_DRAW_STATS:-0}"
export DUSKLIGHT_PORTMASTER_UPLOAD_STATS="${DUSKLIGHT_PORTMASTER_UPLOAD_STATS:-0}"
export DUSKLIGHT_PORTMASTER_DRAW_SETUP_STATS="${DUSKLIGHT_PORTMASTER_DRAW_SETUP_STATS:-0}"
export DUSKLIGHT_PORTMASTER_FRAME_CAPTURE="${DUSKLIGHT_PORTMASTER_FRAME_CAPTURE:-0}"
export DUSKLIGHT_PORTMASTER_FRAME_CAPTURE_AFTER="${DUSKLIGHT_PORTMASTER_FRAME_CAPTURE_AFTER:-1}"
export DUSKLIGHT_PORTMASTER_FRAME_CAPTURE_TOP="${DUSKLIGHT_PORTMASTER_FRAME_CAPTURE_TOP:-12}"
export DUSKLIGHT_PORTMASTER_SKIP_LINE_PRIMS="${DUSKLIGHT_PORTMASTER_SKIP_LINE_PRIMS:-0}"
...
export DUSKLIGHT_PORTMASTER_SAFE_PACING_ALLOW_TRANSITIONS="${DUSKLIGHT_PORTMASTER_SAFE_PACING_ALLOW_TRANSITIONS:-1}"
export DUSKLIGHT_PORTMASTER_DISABLE_DEPTH_PEEK=1
export DUSKLIGHT_PORTMASTER_DRAW_SKIP="${DUSKLIGHT_PORTMASTER_DRAW_SKIP:-0}"
if [ "${DUSKLIGHT_PORTMASTER_SKIP_PIPELINE_CACHE_LOAD:-0}" = "1" ]; then
  export DUSKLIGHT_PORTMASTER_SKIP_PIPELINE_CACHE_LOAD=1
else
  unset DUSKLIGHT_PORTMASTER_SKIP_PIPELINE_CACHE_LOAD
fi
export DUSKLIGHT_PORTMASTER_DISABLE_GRASS_DRAW="${DUSKLIGHT_PORTMASTER_DISABLE_GRASS_DRAW:-0}"
export DUSKLIGHT_PORTMASTER_DISABLE_SHADOW_DRAW="${DUSKLIGHT_PORTMASTER_DISABLE_SHADOW_DRAW:-0}"
export DUSKLIGHT_PORTMASTER_DISABLE_WEATHER_DRAW="${DUSKLIGHT_PORTMASTER_DISABLE_WEATHER_DRAW:-0}"
export DUSKLIGHT_PORTMASTER_CULL_VILLAGE_CLUTTER="${DUSKLIGHT_PORTMASTER_CULL_VILLAGE_CLUTTER:-0}"
export DUSKLIGHT_PORTMASTER_DRAW_DISTANCE_SCALE="${DUSKLIGHT_PORTMASTER_DRAW_DISTANCE_SCALE:-1.0}"
...
export DUSKLIGHT_RENDERDOC_CAPTURE_AFTER="${DUSKLIGHT_RENDERDOC_CAPTURE_AFTER:-0}"
export DUSKLIGHT_RENDERDOC_CAPTURE_PATH="${DUSKLIGHT_RENDERDOC_CAPTURE_PATH:-$RENDERDOC_DIR/captures/dusklight}"
export DUSKLIGHT_RENDERDOC_LIB="${DUSKLIGHT_RENDERDOC_LIB:-$RENDERDOC_DIR/lib/librenderdoc.so}"
...
log_platform_info() {
  ...
  echo "DUSKLIGHT_PORTMASTER_GX_STATS=${DUSKLIGHT_PORTMASTER_GX_STATS:-}"
  echo "DUSKLIGHT_PORTMASTER_ACTOR_STATS=${DUSKLIGHT_PORTMASTER_ACTOR_STATS:-}"
  echo "DUSKLIGHT_PORTMASTER_PROCESS_DRAW_STATS=${DUSKLIGHT_PORTMASTER_PROCESS_DRAW_STATS:-}"
  echo "DUSKLIGHT_PORTMASTER_UPLOAD_STATS=${DUSKLIGHT_PORTMASTER_UPLOAD_STATS:-}"
  echo "DUSKLIGHT_PORTMASTER_FRAME_CAPTURE=${DUSKLIGHT_PORTMASTER_FRAME_CAPTURE:-}"
  echo "DUSKLIGHT_PORTMASTER_FRAME_CAPTURE_AFTER=${DUSKLIGHT_PORTMASTER_FRAME_CAPTURE_AFTER:-}"
  echo "DUSKLIGHT_PORTMASTER_FRAME_CAPTURE_TOP=${DUSKLIGHT_PORTMASTER_FRAME_CAPTURE_TOP:-}"
  echo "DUSKLIGHT_PORTMASTER_SKIP_LINE_PRIMS=${DUSKLIGHT_PORTMASTER_SKIP_LINE_PRIMS:-}"
  echo "DUSKLIGHT_PORTMASTER_DRAW_DISTANCE_SCALE=${DUSKLIGHT_PORTMASTER_DRAW_DISTANCE_SCALE:-}"
  echo "DUSKLIGHT_PORTMASTER_CULL_VILLAGE_CLUTTER=${DUSKLIGHT_PORTMASTER_CULL_VILLAGE_CLUTTER:-}"
  echo "DUSKLIGHT_RENDERDOC_CAPTURE_AFTER=${DUSKLIGHT_RENDERDOC_CAPTURE_AFTER:-}"
  echo "DUSKLIGHT_RENDERDOC_CAPTURE_PATH=${DUSKLIGHT_RENDERDOC_CAPTURE_PATH:-}"
  echo "DUSKLIGHT_RENDERDOC_LIB=${DUSKLIGHT_RENDERDOC_LIB:-}"
  echo "--- devices ---"
...
if [ -d "$RENDERDOC_DIR/lib" ]; then
  export LD_LIBRARY_PATH="$RENDERDOC_DIR/lib:$GAMEDIR/lib.${DEVICE_ARCH}:$GAMEDIR/libs.${DEVICE_ARCH}:$GAMEDIR/lib${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}"
else
